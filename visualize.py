...
custom_prediction = json.load(open('/home/tqsang/scene_graph/Scene-Graph-Benchmark.pytorch/checkpoints/test_output/custom_prediction.json'))
custom_data_info = json.load(open('/home/tqsang/scene_graph/Scene-Graph-Benchmark.pytorch/checkpoints/test_output/custom_data_info.json'))
