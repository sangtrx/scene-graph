...
def main():
    ...
    ### DETECTED_SGG_DIR
    ### TEST.CUSTUM_PATH
    ### ['TEST.CUSTUM_PATH', '/media/Seagate16T/tqminh/ActNetFrames/v_---9CpRcKoU', 
    ### 'DETECTED_SGG_DIR', '/media/Seagate16T/tqsang/scene_graph_output/v_---9CpRcKoU']
    # Create video feature extraction loaders.
    # path_to_video_list = '/home/tqsang/Sang_SlowFast/new_list_anet_rescaled_1600_2.json'
    path_to_video_list = cfg.VIDEO_LIST
    ...
    # for video_name in tqdm(video_list):
        ...
        if folder_name in ignored_list:
            continue
        custum_path = '/media/Seagate16T/tqminh/ActNetFrames/' + folder_name
        output_path = '/media/Seagate16T_sang/scene_graph_output/' + folder_name
        custom_list = ['TEST.CUSTUM_PATH', custum_path, 'DETECTED_SGG_DIR', output_path]
        if osp.isfile(output_path+'/custom_prediction.json'):
            continue
        cfg.merge_from_list(custom_list)
